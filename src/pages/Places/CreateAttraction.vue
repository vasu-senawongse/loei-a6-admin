            ...
            <md-card>
              ...
              <md-card-content>
                ...
                <b-select
                  ...
                  :options="
                    subOptions.filter(
                      (i) => i.district == district || i.district == ''
                    )
                  "
                  class="mb-3"
                />
  ...
  data() {
    return {
      ...
      subOptions: [
        ...
        { text: 'หาดทรายขาว', value: 'หาดทรายขาว', district: 'เชียงคาน' },
        ...
        { text: 'ผาอินทร์แปลง', value: 'ผาอินทร์แปลง', district: 'เอราวัณ' },
        ...
        { text: 'ท่าช้างคล้อง', value: ' ท่าช้างคล้อง', district: 'ผาขาว' },
        ...
        { text: 'ห้วยสีเสียด', value: 'ห้วยสีเสียด', district: 'ภูหลวง' },
        { text: 'เลยวังไสย์', value: 'เลยวังไสย์', district: 'ภูหลวง' },
        { text: 'แก่งศรีภูมิ', value: 'แก่งศรีภูมิ', district: 'ภูหลวง' },
        ...
        { text: 'หนองหญ้าปล้อง', value: 'หนองหญ้าปล้อง', district: 'วังสะพุง' },
